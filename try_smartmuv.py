...
if __name__ == "__main__":
    ...
    if option == "1":
        ...
        # save to json file
        with open(f"tests/output_data/{contract_name}_slot_details.json", "w") as f:
            json.dump(slots_details, f)
        ...
        # save to json file
        with open(f"tests/output_data/{contract_name}_elementary_data.json", "w") as f:
            json.dump(results, f)
        ...
        # save to json file
        with open(f"tests/output_data/{contract_name}_complete_data.json", "w") as f:
            json.dump(contract_state, f)
